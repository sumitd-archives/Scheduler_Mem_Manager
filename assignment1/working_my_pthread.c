...
void my_pthread_create(my_p_thread_t * thread, my_pthread_attr_t * attr, void (*function)(void), void * arg) {
...
void my_pthread_join (my_p_thread_t thread , void ** value_ptr) {
